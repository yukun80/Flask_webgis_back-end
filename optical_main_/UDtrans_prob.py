...
# unet_为自己定义的模型
# from optical_main_.nets.unet import Unet as unet
from optical_main_.nets.TF_configs import get_model_config
from optical_main_.nets.UDTransNet_prob import UDTransNet
from optical_main_.utils.utils import cvtColor, preprocess_input, resize_image, show_config
...
class Unet(object):
    _defaults = {
        "model_path": "./optical_main_/_logs-landslides/best_epoch_weights.pth",
        "num_classes": 2,
        "backbone": "default",
        "input_shape": [256, 256],
        "mix_type": 1,
    ...
    def generate(self, onnx=False):
        ...
        self.net = UDTransNet(config_vit, n_channels=14, n_classes=2, img_size=256)
