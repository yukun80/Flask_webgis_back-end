...
class LossHistory:
    def __init__(self, log_dir, model, input_shape):
        ...
        try:
            dummy_input = torch.randn(2, 2, input_shape[0], input_shape[1])
...
class EvalCallback:
    def __init__(
        self, net, input_shape, num_classes, image_ids, dataset_path, log_dir, cuda, miou_out_path=".temp_miou_out", eval_flag=True, period=1
    ):
    ...
    def on_epoch_end(self, epoch, model_eval):
        if epoch % self.period == 0 and self.eval_flag:
            ...
            for image_id in self.image_ids:
                ...
                #   从文件中读取图像
                # -------------------------------#
                image_path = os.path.join(self.dataset_path, "JPEGImages/" + image_id + ".tif")
