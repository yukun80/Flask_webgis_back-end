...
from LXY_InSAR_DL.nets.deeplabv3_plus import DeepLab
from LXY_InSAR_DL.utils.utils import cvtColor, preprocess_input, resize_image, show_config
...
class DeeplabV3(object):
    _defaults = {
        "model_path": "./LXY_InSAR_DL/logs-landslide/best_epoch_weights.pth",
        # ----------------------------------------#
        #   所需要区分的类的个数+1
        # ----------------------------------------#
        "num_classes": 5,
