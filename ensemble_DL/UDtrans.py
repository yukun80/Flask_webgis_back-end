...
# unet_为自己定义的模型
from ensemble_DL.nets.unet import Unet as unet
from ensemble_DL.nets.TF_configs import get_model_config
from ensemble_DL.nets.UDTransNet import UDTransNet
from ensemble_DL.utils.utils import cvtColor, preprocess_input, resize_image, show_config
...
class Unet(object):
    _defaults = {
        "model_path": r"D:\_codeProject\SlideDetect-main\Flask_detect_Back-end\ensemble_DL\weight\best_epoch_weights.pth",
        "num_classes": 2,
        "backbone": "UDTransNet",
        "input_shape": [256, 256],
        "mix_type": 1,
    ...
    def generate(self, onnx=False):
        ...
        self.net = UDTransNet(config_vit, n_channels=9, n_classes=2, img_size=256)
