...
from ensemble_DL.utils.utils_metrics import compute_metrics

import numpy as np

from ensemble_DL.UDtrans import Unet
...
def segment_image(dir_origin_path, dir_save_path):
    ...
    for img_name in img_names:
        if img_name.lower().endswith((".tif", ".tiff")):
            ...
            writeTiff(final_img, os.path.join(dir_save_path, img_name))
